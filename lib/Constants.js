...
export const TEMP_THRESHOLD = 5 * MINUTE
...
export const IMAGE_TO_WEBP = [
   '-an', '-sn',
   '-vf', 'scale=512:512:force_original_aspect_ratio=decrease:flags=fast_bilinear,pad=512:512:-1:-1:color=0x00000000',
   '-c:v', 'libwebp',
   '-q:v', '70',
   '-lossless', '0',
   '-compression_level', '0',
...
export const VIDEO_TO_WEBP = [
   ...
   '-t', '00:00:05',
   '-an', '-sn',
   '-vf', 'scale=512:512:force_original_aspect_ratio=decrease:flags=fast_bilinear,pad=512:512:-1:-1:color=0x00000000,fps=16',
   '-c:v', 'libwebp',
   '-q:v', '50',
   '-lossless', '0',
   '-compression_level', '0',
...
export const BRAT_GIF_ARGS = [
   '-an', '-sn',
   '-vf', 'scale=256:256:force_original_aspect_ratio=decrease:flags=fast_bilinear,pad=256:256:-1:-1:color=0x00000000,split[s0][s1];[s0]palettegen=max_colors=32:stats_mode=full[p];[s1][p]paletteuse=dither=none,fps=5',
   '-f', 'gif'
]
